...
|:-----------------------------------|--------:|---------:|--------:|
| Pares significativos a 5% (de 91)  | 61.0000 |  62.0000 |  1.0000 |
...
|:--------------------------------------------------|:--------------------------------------------------|:------------------|:------------------|-------:|-------:|----------:|-----------:|-----------:|----------:|:-----------------|---------:|---------------:|:----------------|:----------------------|--------------:|
| deepseek-v4-flash_few_shot                        | llama-3.3-70b_few_shot                            | DeepSeek-V4-Flash | Llama-3.3-70B     | 0.7527 | 0.3396 |    0.4131 |     0.3506 |     0.4754 |    0.0000 | True             |   0.0000 |         0.0000 | True            | True                  |            13 |
| llama-3.3-70b_few_shot                            | qwen2.5-72b_few_shot                              | Llama-3.3-70B     | Qwen2.5-72B       | 0.3396 | 0.6135 |   -0.2740 |    -0.3410 |    -0.2053 |    0.0000 | True             |   0.0000 |         0.0000 | True            | True                  |            13 |
| gpt-5.2_few_shot                                  | llama-3.3-70b_few_shot                            | GPT-5.2           | Llama-3.3-70B     | 0.6067 | 0.3396 |    0.2671 |     0.1969 |     0.3361 |    0.0000 | True             |   0.0000 |         0.0000 | True            | True                  |            13 |
| gpt-4.1-mini_few_shot                             | gpt-4.1-nano_few_shot                             | GPT-4.1-mini      | GPT-4.1-nano      | 0.6851 | 0.4325 |    0.2528 |     0.2050 |     0.2992 |    0.0000 | True             |   0.0000 |         0.0000 | True            | True                  |            13 |
| gpt-5.2_few_shot                                  | deepseek-v4-flash_few_shot                        | GPT-5.2           | DeepSeek-V4-Flash | 0.6067 | 0.7527 |   -0.1461 |    -0.1884 |    -0.1020 |    0.0000 | True             |   0.0000 |         0.0000 | True            | True                  |            13 |
| gpt-4.1_few_shot                                  | gpt-5.2_few_shot                                  | GPT-4.1           | GPT-5.2           | 0.7216 | 0.6067 |    0.1151 |     0.0810 |     0.1500 |    0.0000 | True             |   0.0000 |         0.0000 | True            | True                  |            13 |
| neuralmind_bert-base-portuguese-cased__supervised | bilstm-crf__supervised                            | BERTimbau-base    | BiLSTM-CRF        | 0.6786 | 0.5926 |    0.0857 |     0.0304 |     0.1438 |    0.0020 | True             |   0.0120 |         0.0260 | True            | True                  |            13 |
| gpt-5.1_few_shot                                  | gpt-5.2_few_shot                                  | GPT-5.1           | GPT-5.2           | 0.6847 | 0.6067 |    0.0779 |     0.0460 |     0.1104 |    0.0000 | True             |   0.0000 |         0.0000 | True            | True                  |            13 |
| deepseek-v4-flash_few_shot                        | neuralmind_bert-base-portuguese-cased__supervised | DeepSeek-V4-Flash | BERTimbau-base    | 0.7527 | 0.6786 |    0.0746 |     0.0268 |     0.1222 |    0.0024 | True             |   0.0120 |         0.0312 | True            | True                  |            13 |
| gpt-5.2_few_shot                                  | neuralmind_bert-base-portuguese-cased__supervised | GPT-5.2           | BERTimbau-base    | 0.6067 | 0.6786 |   -0.0715 |    -0.1174 |    -0.0240 |    0.0036 | True             |   0.0120 |         0.0468 | True            | True                  |            13 |
| gpt-4.1_few_shot                                  | gpt-4.1-mini_few_shot                             | GPT-4.1           | GPT-4.1-mini      | 0.7216 | 0.6851 |    0.0366 |     0.0130 |     0.0619 |    0.0020 | True             |   0.0120 |         0.0260 | True            | True                  |            13 |
| gpt-4.1_few_shot                                  | deepseek-v4-flash_few_shot                        | GPT-4.1           | DeepSeek-V4-Flash | 0.7216 | 0.7527 |   -0.0309 |    -0.0616 |    -0.0027 |    0.0298 | True             |   0.0596 |         0.3874 | False           | False                 |            13 |
| gpt-5.2_few_shot                                  | qwen2.5-72b_few_shot                              | GPT-5.2           | Qwen2.5-72B       | 0.6067 | 0.6135 |   -0.0069 |    -0.0478 |     0.0341 |    0.7308 | False            |   0.7308 |         1.0000 | False           | False                 |            13 |
...
| n_total_pairs                  | 78                           |
| n_significant_5pct_uncorrected | 62                           |
| highlighted_family_size        | 13                           |
| highlighted_n_sig_uncorrected  | 12                           |
| highlighted_n_sig_holm         | 11                           |
