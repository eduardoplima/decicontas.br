...
Documento auto-contido: todas as tabelas aparecem inline. Os CSVs ao lado deste arquivo são as fontes canônicas (uma por bloco), geradas por `tools.release.chapter5_numbers`. Cada bloco abaixo corresponde a um item do checklist do capítulo.
...
**Resumo das decisões e contagens de tokens:**

| metric                 |   value |
|:-----------------------|--------:|
| groups_total           |     794 |
| groups_decided_>=0.95  |     567 |
| groups_below_threshold |     227 |
| token_changes          |    4199 |
| decision_accept        |     183 |
| decision_reject        |    3238 |
| decision_custom        |     778 |
...
| model                                              | display              |   token_f1 |   token_precision |   token_recall |   span_f1 |   span_precision |   span_recall |
|:---------------------------------------------------|:---------------------|-----------:|------------------:|---------------:|----------:|-----------------:|--------------:|
| gpt-4-turbo                                        | GPT-4 Turbo          |     0.8096 |            0.8188 |         0.8006 |    0.7321 |           0.6721 |        0.8039 |
| gpt-5.4-mini_few_shot                              | GPT-5.4-mini         |     0.7931 |            0.8167 |         0.7708 |    0.7269 |           0.6806 |        0.7800 |
| gpt-4o                                             | GPT-4o               |     0.8038 |            0.8216 |         0.7867 |    0.7237 |           0.6654 |        0.7930 |
| gpt-5.4-nano_few_shot                              | GPT-5.4-nano         |     0.7876 |            0.8141 |         0.7628 |    0.7229 |           0.6704 |        0.7843 |
| gpt-41-mini                                        | GPT-4.1-mini         |     0.7915 |            0.7956 |         0.7874 |    0.7108 |           0.6498 |        0.7843 |
| gpt-35                                             | GPT-3.5              |     0.7891 |            0.8052 |         0.7735 |    0.7065 |           0.6502 |        0.7734 |
| gpt-41                                             | GPT-4.1              |     0.7945 |            0.7795 |         0.8102 |    0.7052 |           0.6321 |        0.7974 |
| gemini-2.5-flash_few_shot                          | Gemini-2.5-flash     |     0.7614 |            0.7508 |         0.7724 |    0.6867 |           0.6189 |        0.7712 |
| neuralmind_bert-base-portuguese-cased__supervised  | BERTimbau-base       |     0.7683 |            0.9506 |         0.6447 |    0.6786 |           0.7994 |        0.5895 |
| deepseek-v3_few_shot                               | DeepSeek-V3          |     0.7422 |            0.7499 |         0.7347 |    0.6459 |           0.5700 |        0.7451 |
| rufimelo_Legal-BERTimbau-base__supervised          | Legal-BERTimbau-base |     0.6855 |            0.9474 |         0.5371 |    0.6021 |           0.8223 |        0.4749 |
| neuralmind_bert-large-portuguese-cased__supervised | BERTimbau-large      |     0.6820 |            0.9607 |         0.5287 |    0.6018 |           0.8285 |        0.4726 |
| bilstm-crf__supervised                             | BiLSTM-CRF           |     0.7307 |            0.8455 |         0.6434 |    0.5926 |           0.7742 |        0.4800 |
| gpt-41-nano                                        | GPT-4.1-nano         |     0.5738 |            0.5752 |         0.5725 |    0.4186 |           0.3426 |        0.5381 |
...
| model        | method           |   token_f1 |   token_precision |   token_recall |   span_f1 |   span_precision |   span_recall |
|:-------------|:-----------------|-----------:|------------------:|---------------:|----------:|-----------------:|--------------:|
| gpt-3.5      | function_calling |     0.7891 |            0.8052 |         0.7735 |    0.7065 |           0.6502 |        0.7734 |
| gpt-3.5      | json_schema      |     0.7363 |            0.7768 |         0.6998 |    0.6498 |           0.6068 |        0.6993 |
| gpt-4o       | function_calling |     0.8038 |            0.8216 |         0.7867 |    0.7237 |           0.6654 |        0.7930 |
| gpt-4o       | json_schema      |     0.7434 |            0.7933 |         0.6994 |    0.6556 |           0.6257 |        0.6885 |
| gpt-5.4-mini | function_calling |     0.7931 |            0.8167 |         0.7708 |    0.7269 |           0.6806 |        0.7800 |
| gpt-5.4-mini | json_schema      |     0.5814 |            0.8061 |         0.4546 |    0.5357 |           0.6294 |        0.4662 |
| gpt-5.4-nano | function_calling |     0.7876 |            0.8141 |         0.7628 |    0.7229 |           0.6704 |        0.7843 |
| gpt-5.4-nano | json_schema      |     0.7552 |            0.8085 |         0.7085 |    0.6784 |           0.6457 |        0.7146 |
...
| model            | technique        |   token_f1 |   token_precision |   token_recall |   span_f1 |   span_precision |   span_recall |
|:-----------------|:-----------------|-----------:|------------------:|---------------:|----------:|-----------------:|--------------:|
| deepseek-v3      | cot              |     0.6017 |            0.6759 |         0.5422 |    0.5123 |           0.5021 |        0.5229 |
| deepseek-v3      | dynamic_few_shot |     0.6789 |            0.6707 |         0.6874 |    0.5373 |           0.4397 |        0.6906 |
| deepseek-v3      | few_shot         |     0.7422 |            0.7499 |         0.7347 |    0.6459 |           0.5700 |        0.7451 |
| deepseek-v3      | two_stage        |     0.7678 |            0.7667 |         0.7689 |    0.6718 |           0.6003 |        0.7625 |
| gemini-2.5-flash | cot              |     0.7752 |            0.7752 |         0.7751 |    0.7118 |           0.6471 |        0.7908 |
| gemini-2.5-flash | dynamic_few_shot |     0.7799 |            0.7754 |         0.7845 |    0.6879 |           0.6181 |        0.7756 |
| gemini-2.5-flash | few_shot         |     0.7614 |            0.7508 |         0.7724 |    0.6867 |           0.6189 |        0.7712 |
| gemini-2.5-flash | two_stage        |     0.7740 |            0.7605 |         0.7880 |    0.7025 |           0.6377 |        0.7821 |
| gpt-5.4-mini     | cot              |     0.7928 |            0.8154 |         0.7713 |    0.7072 |           0.6610 |        0.7603 |
| gpt-5.4-mini     | dynamic_few_shot |     0.7532 |            0.7990 |         0.7122 |    0.6546 |           0.6071 |        0.7102 |
| gpt-5.4-mini     | few_shot         |     0.7931 |            0.8167 |         0.7708 |    0.7269 |           0.6806 |        0.7800 |
| gpt-5.4-mini     | two_stage        |     0.7452 |            0.7965 |         0.7002 |    0.6556 |           0.6275 |        0.6863 |
| gpt-5.4-nano     | cot              |     0.7996 |            0.8282 |         0.7730 |    0.7333 |           0.6953 |        0.7756 |
| gpt-5.4-nano     | dynamic_few_shot |     0.7417 |            0.7929 |         0.6967 |    0.6687 |           0.6301 |        0.7124 |
| gpt-5.4-nano     | few_shot         |     0.7876 |            0.8141 |         0.7628 |    0.7229 |           0.6704 |        0.7843 |
| gpt-5.4-nano     | two_stage        |     0.7607 |            0.8083 |         0.7185 |    0.6914 |           0.6569 |        0.7298 |
...
## K. Token F1 do GPT-4-turbo (canônico)
